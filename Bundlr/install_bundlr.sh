...
curl -s https://raw.githubusercontent.com/Bitoliy/Nodes/main/Tools/node.sh | bash &>/dev/null
curl -s https://raw.githubusercontent.com/Bitoliy/Nodes/main/Tools/install_docker.sh | bash &>/dev/null
